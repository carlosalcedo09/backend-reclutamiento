...
class JobOffers(BaseModel):
    ...
    employment_type = models.CharField(verbose_name="Tipo de trabajo", max_length=50, null=True, blank=True, choices=TypeJobChoices.choices)
    ...
    mode =  models.CharField(verbose_name="Modalidad", max_length=50, null=True, blank=True, choices=ModeChoices.choices)
...
class JobBenefits(BaseModel):
    jobOffers = models.ForeignKey(JobOffers, on_delete=models.CASCADE, related_name="benefits_joboffert")
    description =  models.CharField(verbose_name="Description de requisitos", max_length=255)
    ...
    def save(self, *args, **kwargs):
        if not self.candidate_snapshot:
            ...
            snapshot = {
                ...
                "photograph": candidate.photograph.url if candidate.photograph else None,
                ...
                "availability": candidate.avaliability,
                "skills": [
